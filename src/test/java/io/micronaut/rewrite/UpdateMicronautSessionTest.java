...
public class UpdateMicronautSessionTest implements RewriteTest {
    ...
    public void defaults(RecipeSpec spec) {
        spec.recipeFromResource("/META-INF/rewrite/micronaut3-to-4.yml", "io.micronaut.rewrite.UpdateMicronautPlatformBom", "io.micronaut.rewrite.UpdateMicronautSession");
    }
